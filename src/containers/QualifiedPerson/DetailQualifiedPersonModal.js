...
const DetailQualifiedPersonModal = ({ hide_modal, dataDetail }) => {
  const onHide = () => {
    hide_modal();
  };
...
export default reduxForm({
  form: "DetailQualifiedPersonModal",
})(connect(mapStateToProps, mapDispatchToProps)(DetailQualifiedPersonModal));
