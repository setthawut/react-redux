...
const DetailAppealModal = ({ hide_modal, dataDetail }) => {
  const onHide = () => {
    hide_modal();
  };
          ...
          <Row style={{ marginTop: "15px" }}>
            <Col xs={12}>
              <Row>
                ...
                <Col xs={9}>
                  {dataDetail.type === "KhoRongrian"
                    ? "ข้อร้องเรียน"
                    : dataDetail.type === "Khosanoenae"
                    ? "ข้อเสนอแนะ"
                    : ""}
                </Col>
              </Row>
...
export default reduxForm({
  form: "DetailAppealModal",
})(connect(mapStateToProps, mapDispatchToProps)(DetailAppealModal));
